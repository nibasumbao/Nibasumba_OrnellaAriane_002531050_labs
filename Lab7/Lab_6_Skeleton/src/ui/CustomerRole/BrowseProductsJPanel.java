...
public class BrowseProductsJPanel extends javax.swing.JPanel {
    ...
    public BrowseProductsJPanel(JPanel userProcessContainer, SupplierDirectory supplierDirectory,MasterOrderList masterOrderList) {
        ...
        this.currentOrder = masterOrderList.newOrder();
    ...
    private void btnAddToCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToCartActionPerformed
        ...
        if (salesPrice< product.getSalesPrice()){
            JOptionPane.showMessageDialog(this, "Price should be more thatn it is set in the price.");
            return;
        }
 ...
 private void populateCartTable() {
    ...
    private void populateProductTable(String keyword) {
        ...
        populateProductTable();   // call the default version that loads selected supplier
        return;
    }
        DefaultTableModel model = (DefaultTableModel) tblProductCatalog.getModel();
        model.setRowCount(0);
